...
const MobileNav = ({ openNav, isOpen }: Props) => {
    return (
        <div className='md:hidden'>
            ...
            <div className={`fixed flex flex-col items-center justify-between w-full h-[40%] bg-transparent z-40 ${isOpen ? 'translate-y-0' : '-translate-y-[200%]'} transition duration-800 ease-out`}>
                {navLinks.map((link) => (
